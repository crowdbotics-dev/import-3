"""
Django settings for import_3 project.
...
WSGI_APPLICATION = 'import_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "import_3 API",
    "DESCRIPTION": "API documentation for import_3 App",
    "VERSION": "v1",
}
